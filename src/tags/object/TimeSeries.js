 ...
 *
 * Note: Time axis should be sorted in your samples, otherwise TimeSeries breaks.
 * To use autogenerated indices as time axes you can skip the `timeColumn` parameter.
 * @example
